      ...
      <div className="bg-green-600 text-white py-24 px-8 text-center">
        ...
        <div className="flex max-w-lg mx-auto gap-0">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-l-lg text-gray-800 outline-none text-sm bg-gray-100 placeholder-gray-400"
          />
          <button
            onClick={() => setSearch(input)}
            className="bg-gray-700 px-6 py-3 rounded-r-lg hover:bg-gray-800 transition font-medium text-white">
            Search
          </button>
        </div>
      </div>
